		...
		<section>
			...
			<div class="hottopic">
				...
				<div class="charBox">
					...
					<div class="character" style="background-image: url('resources/images/legends/front/seer_32_crop.png'); background-size: cover;">
					</div>

					<div class="character" style="background-image: url('resources/images/legends/front/ash_32_crop.png'); background-size: cover;">
					</div>
					
					<div class="character" style="background-image: url('resources/images/legends/front/catalyst_32_crop.png'); background-size: cover;">
					</div>
					
					<div class="character" style="background-image: url('resources/images/legends/front/horizon_32_crop.png'); background-size: cover;">
					</div>
					
					<div class="character" style="background-image: url('resources/images/legends/front/loba_32_crop.png'); background-size: cover;">
					</div>
